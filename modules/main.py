...
async def start_handler(client: Client, message):
    ...
    text = (
    "**✨ Welcome, {name}! ✨**\n\n"
    "**I'm 🛡️ShieldX Protector🤖 Bot** — your all-in-one AI Group Security system.\n\n"
    "**🔹 Key Protections:**\n"
    "   • Detects & removes links from user bios 🔗\n"
    "   • Auto-deletes edited NSFW or spam messages 🧹\n"
    "   • Smart abuse filter with /abuse on | off ⚔️\n"
    "   • Custom warning limits with punishments 🚨\n"
    "   • Whitelist management for trusted members ✅\n\n"
    ...
    kb = InlineKeyboardMarkup([
        ...
        [
            InlineKeyboardButton("🛠️ Support", url="),
...
async def cmd_abuse_toggle(client: Client, message: Message):
    ...
    if not await is_admin(client, chat_id, from_user.id):
        return await message.reply("❌ Only admins/creator can toggle abuse filter!")
    ...
    await message.reply(f"⚡ Abuse filter is now **{status_text}** for this group.")
